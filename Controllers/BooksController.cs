...
namespace EbruDilaAydın_BookStore.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,PageCount,PublishTime,PublisherId,CategoryID")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,PageCount,PublishTime,PublisherId,CategoryID")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
